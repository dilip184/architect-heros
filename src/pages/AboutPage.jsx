    ...
    <div className="w-full">
      ...
      <section className="relative min-h-96 flex items-center justify-center bg-gradient-to-r from-primary to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          >
            Delivering exceptional architecture and engineering solutions since 2010
          </motion.p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              At ArchitectHeros, we're committed to transforming design visions into built reality. Our mission is to provide world-class architectural and engineering services that combine innovation, quality, and efficiency.
            </p>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              We believe in the power of good design to create spaces that inspire, function optimally, and stand the test of time.
            </p>
          ...
          >
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  title: 'Innovation',
                  description: 'We embrace new technologies and approaches to solve complex design challenges.',
                },
                {
                  title: 'Collaboration',
                  description: 'We work as partners with our clients, understanding their unique needs.',
                },
                {
                  title: 'Integrity',
      ...
      <section className="section-container bg-light">
        ...
        <div className="max-w-3xl mx-auto">
          {[
            { year: '2010', event: 'Founded ArchitectHeros with a vision to revolutionize architectural services' },
            { year: '2013', event: 'Expanded to offer BIM consulting services' },
            { year: '2016', event: 'Launched MEP engineering division' },
            { year: '2019', event: 'Introduced Scan to BIM services' },
            { year: '2023', event: 'Reached 500+ completed projects milestone' },
            { year: '2024', event: 'Expanded globally with partnerships in 45+ states' },
          ].map((timeline, index) => (
            <motion.div
              key={index}
            ...
            >
              ...
              {index < 5 && <div className="absolute left-3 top-6 w-0.5 h-12 bg-primary" />}
              <div>
                <p className="text-primary font-bold text-lg">{timeline.year}</p>
      ...
      {/* CTA Banner */}
      <CTABanner heading="Join Our Growing List of Satisfied Clients" primaryText="Get In Touch" />
    </div>
  );
}
